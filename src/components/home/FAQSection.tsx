...
export function FAQSection() {
  ...
  return (
    <section>
      <div className="container lg:max-w-6xl mx-auto !flex bg-muted px-4 py-16 sm:px-6 lg:px-8 border-2 gap-5 my-10">
        <div className={"basis-1/2 flex flex-col gap-4"}>
          <h2 className="text-3xl font-bold">Still got questions?</h2>
          <p className="text-muted-foreground w-2/3">
            Got more questions? Ask away! Get in touch with our UK-based support
            team either on
            <a
