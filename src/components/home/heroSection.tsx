            ...
            <div className="mx-auto px-4 flex flex-col lg:flex-row items-center justify-center gap-10">
                ...
                <div className="max-w-[700px] w-full space-y-6">
                    ...
                    <p className="text-gray-700">
                        You’ve got enough on your plate. Let us take care of the numbers. This isn’t
                        a one-size-fits-all service. We offer personalised, proactive support that’s
                        built around you, not just what HMRC expects. We’re with you every step of
                        the way:
                    </p>
                    ...
                    <p className="text-gray-700">
                        Whether you&apos;re self-employed, running a company, or juggling multiple
                        income streams, we make tax straightforward, stress-free, and surprisingly
                        human.
                    </p>
                </div>
                ...
                <div className="relative w-full max-w-[600px] flex justify-center items-center">
                    <div className="relative rounded-full overflow-hidden w-[300px] h-[300px] md:w-[360px] md:h-[360px] shadow-xl">
                        <Image src="/assets/girl.png" alt="Support" fill className="object-cover" />
                    </div>
