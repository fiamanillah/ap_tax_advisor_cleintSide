...
export default function TaxAdviceLoading() {
  return (
    <div className="min-h-screen bg-white relative">
      {/* YouTube-like top loading bar - Blue theme */}
      <div className="fixed top-0 left-0 w-full h-1 bg-gray-100 z-50 overflow-hidden">
        <div className="h-full bg-gradient-to-r from-blue-500 via-blue-600 to-indigo-500 animate-loading-bar shadow-sm"></div>
      </div>

      {/* Secondary loading indicator */}
      <div className="fixed top-1 left-0 w-full h-0.5 bg-transparent z-40 overflow-hidden">
        <div className="h-full bg-blue-400 opacity-50 animate-youtube-progress"></div>
      </div>
      ...
      <div className="opacity-15 pointer-events-none">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="space-y-4">
            <div className="h-8 w-3/4 bg-blue-200 rounded animate-pulse"></div>
